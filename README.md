...
- **Patient Bracelet**  
  Monitors heart rate and SpO₂ using a PPG sensor and detects sustained abnormal patterns.

- **Caregiver Ring**  
  Receives instant offline alerts via RF communication, vibrates for attention, and displays a QR code to access the patient’s location.
...
## **System Architecture**
1. Bracelet monitors heart activity continuously  
2. Abnormal pattern detected using rule-based logic  
3. Alert sent via RF (NRF24) to caregiver ring  
4. Ring vibrates and displays QR code  
5. Caregiver scans QR to view patient location  
